...
public class BotPlayer1 extends Tank{
    DataOutputStream toClient;
    boolean hasClient = false;
    public BotPlayer1(Position pos, ImageView image) {
        super(pos, image);
    }
